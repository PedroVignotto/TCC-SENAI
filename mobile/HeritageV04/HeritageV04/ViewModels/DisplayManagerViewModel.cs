...
{
    public class DisplayManagerViewModel : ViewModelBase
    {
        ...
        private bool nullEnvironments;
        public bool NullEnvironments
        {
            get { return nullEnvironments; }
            set { SetProperty(ref nullEnvironments, value); }
        }

        private bool bodyEnvironments;
        public bool BodyEnvironments
        {
            get { return bodyEnvironments; }
            set { SetProperty(ref bodyEnvironments, value); }
        }

        private bool loadEnvironments;
        public bool LoadEnvironments
        {
            get { return loadEnvironments; }
            set { SetProperty(ref loadEnvironments, value); }
        }

        private int heightListViewEnvironments;
        public int HeightListViewEnvironments
        {
            get { return heightListViewEnvironments; }
            set { SetProperty(ref heightListViewEnvironments, value); }
        }

        #endregion

        public DisplayManagerViewModel(INavigationService navigationService, IHeritageAPIService heritageAPIService, IPageDialogService pageDialogService, IDialogService dialogService) : base(navigationService, heritageAPIService, pageDialogService, dialogService)
        {
            Title = "Gerenciador";
        }
        ...
        public async override void Initialize(INavigationParameters parameters)
        {
            ...
            {
                "Administrador", "Gerenciador", "Suporte"
            };
        ...
        private async Task LoadAsync()
        {
            try
            {
                ...
                if (Environments.Count == 0)
                    NullEnvironments = true;
                else
                {
                    HeightListViewEnvironments = Environments.Count * 135;
                    BodyEnvironments = true;
                }
